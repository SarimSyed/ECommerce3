...
namespace ECommerce.Api.Products.Providers
{
    public class ProductsProvider : IProductsProvider
    {
        ...
        private void SeedData()
        {
            ...
            {
                dbContext.Products.Add(new Db.Product() { Id = 1, Name = "Keyboard", Price = 100, Inventory = 95 });
                dbContext.Products.Add(new Db.Product() { Id = 2, Name = "Power Supply", Price = 95, Inventory = 40 });
                ...
                dbContext.Products.Add(new Db.Product() { Id = 5, Name = "Mother Board", Price = 140, Inventory = 200 });
